<?php /* Smarty version Smarty-3.0.8, created on 2014-04-14 23:05:49
         compiled from "D:\WWW\game/tpl\game/shop_woman.html" */ ?>
<?php /*%%SmartyHeaderCode:23462534bf94dae1d14-31887111%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '61ed0cff9a02879ae3ec0c2b0c880fc696d6f88d' => 
    array (
      0 => 'D:\\WWW\\game/tpl\\game/shop_woman.html',
      1 => 1397487940,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '23462534bf94dae1d14-31887111',
  'function' => 
  array (
  ),
...
<div data-role="collapsible">  
 <h1>C级人物购买</h1> 
   <div class="m">
    <div class="img"><img src="tpl/game/images/c_f.jpg" width="100%" height="100" /></div>
     <div class="sth">
     <div class="name">nvde</div>
...
" data-ajax="false">立即购买</a></div>
 ...
 <h1>B级人物购买</h1> 
     <div class="m">
    <div class="img"><img src="tpl/game/images/b_f.jpg" width="100%" height="100" /></div>
     <div class="sth">
...
<div data-role="collapsible">  
 <h1>A级人物购买</h1> 
    <div class="m">
    <div class="img"><img src="tpl/game/images/a_f.jpg" width="100%" height="100" /></div>
     <div class="sth">
     <div class="name">RENWU</div>
     <div class="level">$5000</div>
...
<div data-role="collapsible">  
 <h1>S级人物购买</h1> 
     <div class="m">
    <div class="img"><img src="tpl/game/images/s_f.jpg" width="100%" height="100" /></div>
     <div class="sth">
     <div class="name">RENWU</div>
     <div class="level">$5000</div>
